      ...
      {journals.length === 0 ? (
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {journals.map((journal) => (
            <div
              key={journal._id}
              className="group bg-slate-900 border border-white/10 rounded-2xl overflow-hidden hover:border-blue-500/50 transition shadow-lg"
            >
              {/* کاور و دکمه‌ها */}
              ...
              <div className="p-4 text-center border-t border-white/5">
                ...
                <a
                  href={journal.pdfUrl}
                  download
                  className="inline-flex justify-center items-center w-full bg-blue-600 text-white px-4 py-2 rounded-xl font-bold gap-2 hover:bg-blue-500 transition shadow-md text-sm"
                >
...
//                             {/* 💡 FIX: اضافه کردن دکمه "مطالعه آنلاین" و تنظیم استایل برای دو دکمه */}
//                             <div className="flex gap-3">
//                                 {/* دکمه ۱: مطالعه آنلاین */}
//                                 <Link 
//                                     href={`/journals/view/${journal._id}`} 
//                                     className="flex-1 inline-flex justify-center items-center w-full bg-cyan-600/10 text-cyan-400 border border-cyan-600/50 px-4 py-2 rounded-xl font-bold gap-2 hover:bg-cyan-600 hover:text-white transition shadow-md text-sm"
//                                 >
...
//                                     href={journal.pdfUrl} 
//                                     download 
//                                     className="flex-1 inline-flex justify-center items-center w-full bg-blue-600 text-white px-4 py-2 rounded-xl font-bold gap-2 hover:bg-blue-500 transition shadow-md text-sm"
//                                 >

...
export default function EditPostPage() {
  ...
  return (
    <div className="container mx-auto max-w-2xl px-4 py-24">
      <h1 className="mb-8 text-3xl font-bold text-white text-center">ویرایش خبر ✏️</h1>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input 
                ...
                required className="w-full rounded-xl bg-white/5 py-3 pr-10 pl-4 text-white focus:ring-2 focus:ring-blue-500" 
            />
          </div>
        </div>

        <div>
          <label className="mb-2 block text-sm text-gray-400">آدرس یکتا (Slug)</label>
          <input 
                value={formData.slug}
                onChange={(e) => setFormData({...formData, slug: e.target.value})}
                required className="w-full rounded-xl bg-white/5 py-3 px-4 text-white focus:ring-2 focus:ring-blue-500" 
          />
        </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <textarea 
                ...
                rows={10} required className="w-full rounded-xl bg-white/5 py-3 pr-10 pl-4 text-white focus:ring-2 focus:ring-blue-500" 
            />
          </div>
        </div>

        <button disabled={saving} type="submit" className="w-full flex justify-center rounded-xl bg-green-600 py-4 font-bold text-white transition hover:bg-green-500 gap-2">
